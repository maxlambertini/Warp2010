...
TurbulenceBillow::TurbulenceBillow ():
  Module (GetSourceModuleCount ()),
  m_power (DEFAULT_TURBULENCE_B_POWER)
{
  SetSeed (DEFAULT_TURBULENCE_B_SEED);
  SetFrequency (DEFAULT_TURBULENCE_B_FREQUENCY);
  SetRoughness (DEFAULT_TURBULENCE_B_ROUGHNESS);
}

double TurbulenceBillow::GetFrequency () const
{
...
int TurbulenceBillow::GetSeed () const
{
  return m_xDistortModule.GetSeed ();
}

double TurbulenceBillow::GetValue (double x, double y, double z) const
{
...
void TurbulenceBillow::SetSeed (int seed)
{
