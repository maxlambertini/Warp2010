  ...
  namespace module
  {
    ...
    class NOISE_SHARED_EXPORT Module
    {
      ...
      public:
        ...
        virtual void SetCtl (const Module& sourceModule) { SetSourceModule(2, sourceModule); }
        ...
        virtual const Module& GetCtl() const {  return GetSourceModule(2);}
    ...
    protected:
      ...
      private:
        ...
        /// copied as well.
        const Module& operator= (const Module& m __attribute__((unused)) )
        {
          return *this;
        }
