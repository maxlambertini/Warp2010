...
TurbulenceRidged ::TurbulenceRidged  ():
  Module (GetSourceModuleCount ()),
  m_power (DEFAULT_TURBULENCE_R_POWER)
{
  SetSeed (DEFAULT_TURBULENCE_R_SEED);
  SetFrequency (DEFAULT_TURBULENCE_R_FREQUENCY);
  SetRoughness (DEFAULT_TURBULENCE_R_ROUGHNESS);
}

double TurbulenceRidged ::GetFrequency () const
{
...
int TurbulenceRidged ::GetSeed () const
{
  return m_xDistortModule.GetSeed ();
}

double TurbulenceRidged ::GetValue (double x, double y, double z) const
{
...
void TurbulenceRidged ::SetSeed (int seed)
{
