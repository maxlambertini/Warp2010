...
#ifndef NOISE_MODULE_TURBULENCE2_H
#define NOISE_MODULE_TURBULENCE2_H
...
namespace noise
{
  ...
  namespace module 
  {
    ...
    const double DEFAULT_TURBULENCE2_FREQUENCY = DEFAULT_PERLIN_FREQUENCY;

    /// Default power for the noise::module::Turbulence noise module.
    const double DEFAULT_TURBULENCE2_POWER = 1.0;

    /// Default roughness for the noise::module::Turbulence noise module.
    const int DEFAULT_TURBULENCE2_ROUGHNESS = 3;

    /// Default noise seed for the noise::module::Turbulence noise module.
    const int DEFAULT_TURBULENCE2_SEED = DEFAULT_PERLIN_SEED;
    ...
    class NOISE_SHARED_EXPORT Turbulence2: public Module
    {
      ...
      public:
        ...
        void makeNoiseModuleX(int iSeed);
        void makeNoiseModuleY(int iSeed);
        void makeNoiseModuleZ(int iSeed);
      ...
      protected:
        ...
        std::shared_ptr<INoiseModule> m_xDistortModule;

        /// Noise module that displaces the @a y coordinate.
        std::shared_ptr<INoiseModule> m_yDistortModule;

        /// Noise module that displaces the @a z coordinate.
        std::shared_ptr<INoiseModule> m_zDistortModule;
