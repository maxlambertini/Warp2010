...
#ifndef NOISE_MODULE_RIDGEDMULTI2_H
#define NOISE_MODULE_RIDGEDMULTI2_H
...
namespace noise
{
  ...
  namespace module
  {
    ...
    const double DEFAULT_RIDGED2_EXPONENT = 1.0;
    const double DEFAULT_RIDGED2_GAIN = 2.0;
    const double DEFAULT_RIDGED2_OFFSET = 1.0;
    const double DEFAULT_RIDGED2_WEIGHT = 1.0;

    /// Default frequency for the noise::module::RidgedMulti noise module.
    const double DEFAULT_RIDGED2_FREQUENCY = 1.0;

    /// Default lacunarity for the noise::module::RidgedMulti noise module.
    const double DEFAULT_RIDGED2_LACUNARITY = 2.0;

    /// Default number of octaves for the noise::module::RidgedMulti noise
    /// module.
    const int DEFAULT_RIDGED2_OCTAVE_COUNT = 6;

    /// Default noise quality for the noise::module::RidgedMulti noise
    /// module.
    const noise::NoiseQuality DEFAULT_RIDGED2_QUALITY = QUALITY_STD;

    /// Default noise seed for the noise::module::RidgedMulti noise module.
    const int DEFAULT_RIDGED2_SEED = 0;

    /// Maximum number of octaves for the noise::module::RidgedMulti noise
    /// module.
    const int RIDGED2_MAX_OCTAVE = 30;
    ...
    class NOISE_SHARED_EXPORT RidgedMulti2: public Module, public INoiseModule
    {
      ...
      public:
        ...
        /// noise::module::DEFAULT_RIDGED2_OCTAVE_COUNT.
        ///
        /// The default frequency is set to
        /// noise::module::DEFAULT_RIDGED2_FREQUENCY.
        ///
        /// The default lacunarity is set to
        /// noise::module::DEFAULT_RIDGED2_LACUNARITY.
        ///
        /// The default seed value is set to
        /// noise::module::DEFAULT_RIDGED2_SEED.
        RidgedMulti2 ();
        ...
        {
          if (octaveCount > RIDGED2_MAX_OCTAVE) {
      ...
      protected:
        ...
        double m_pSpectralWeights[RIDGED2_MAX_OCTAVE];
